/**
 * PartyFinder Component - Campaign Discovery & Hosting
 *
 * Dual-mode interface:
 *
 * MODE 1 - BROWSE:
 * - Browse public campaigns currently hosting
 * - Send join requests with character selection
 * - Track request status (pending, approved, rejected)
 * - Enter lobby when approved
 *
 * MODE 2 - HOST (My Campaigns):
 * - View campaigns created by current user (creator-only, not joined campaigns)
 * - Toggle hosting status (start/stop hosting)
 * - Approve/reject player join requests
 * - Option to block users
 * - Enter lobby when hosting
 *
 * KEY AUTHORIZATION:
 * - Browse: public, joinable campaigns only
 * - Host: campaigns where createdBy === currentUserId
 * - Join requests: character + access code validation
 * - Approvals: DM/creator only
 */
